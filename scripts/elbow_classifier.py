...
parser.add_argument('--model', default='keras_efficientnet',type=str,metavar='m',help='Model Choice')
...
ecdl.utils.dir_creator(exp_path)
...
with strategy.scope():        
    ...
    # if args.model == 'efficientnet':
    #     model = ecdl.model_files.create_efficientnet_model(relu_units = 120,learning_rate=args.learning_rate)        
    ...
    # ecdl.utils.save_args(args,os.path.join(exp_path,'hyperparameters.json'))
